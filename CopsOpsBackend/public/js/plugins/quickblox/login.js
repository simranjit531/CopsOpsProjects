...
Login.prototype.setListeners = function(){
    var self = this,
        ...
        formInputs = [loginForm.userName, loginForm.userGroup, loginForm.userLogin, loginForm.userEmail, loginForm.userPassword],
    ...
    loginForm.addEventListener('submit', function(e){
        ...
        var userName = loginForm.userName.value.trim(),
            ...
            userEmail = loginForm.userEmail.value.trim(),
            userPassword = loginForm.userPassword.value.trim();
