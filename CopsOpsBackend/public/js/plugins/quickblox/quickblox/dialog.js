...
Dialog.prototype.loadDialogs = function (type) {
    ...
    return new Promise(function(resolve, reject){
        ...
        if (type === 'chat') {
        	console.log(CONSTANTS.DIALOG_TYPES.CHAT, CONSTANTS.DIALOG_TYPES.GROUPCHAT);
        ...
        QB.chat.dialog.list(filter, function (err, resDialogs) {
            ...
            _.each(dialogs, function (dialog) {
                ...
                console.log(self._cache[dialog._id]);
...
Dialog.prototype.renderMessages = function (dialogId) {
    ...
    if (!document.forms.send_message) {
        ...
        */
        ...
        self.quitLink.dataset.dialog = self.dialogId;
    ...
    QB.chat.dialog.create(params, function (err, createdDialog) {
        if (err) {
			...
			*/
            ...
            var type = params.type === CONSTANTS.DIALOG_TYPES.PUBLICCHAT ? 'create' : 'chat',
