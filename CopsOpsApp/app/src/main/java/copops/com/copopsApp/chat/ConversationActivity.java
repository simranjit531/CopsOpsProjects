...
public class ConversationActivity extends AppCompatActivity implements AttachmentSender.UploadListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivBackArrow=findViewById(R.id.iv_recent_back_arrow);
        loadMessagePb = findViewById(R.id.load_message_pb);
        userneame = findViewById(R.id.userDisplayName);
        loadingView = findViewById(R.id.loading_view);
        mMessagesList.setLoadingView(loadingView);
        ivBackArrow.setOnClickListener(onClickBack);
    ...
    //  setSupportActionBar(headerView.getToolbar());
      // getSupportActionBar().setDisplayHomeAsUpEnabled(true);
       ...
       displayName=intent.getStringExtra("DISPLY_NAME");
   //  Toolbar mToolbar= headerView.getToolbar();
    //   String strTitle=mToolbar.getTitle().toString();
        if (!displayName.equals(""))
            userneame.setText(""+displayName);
        else
            userneame.setText("Back Office");
