...
import copops.com.copopsApp.chatmodule.ui.widget.AttachmentPreviewAdapterView;
import copops.com.copopsApp.chatmodule.utils.chat.ChatHelper;
import copops.com.copopsApp.chatmodule.utils.qb.PaginationHistoryListener;
...
//if(menu.findItem(R.id.menu_chat_action_info) == R.string.menu_chat_action_info)
        return true;
    }
