...
//        GlideApp.with(this)
//                .load(url).apply(new RequestOptions().override(Consts.PREFERRED_IMAGE_SIZE_FULL, Consts.PREFERRED_IMAGE_SIZE_FULL))
//                .into(imageView);
//        Glide.with(this)
//                .load(url).override(Consts.PREFERRED_IMAGE_SIZE_FULL, Consts.PREFERRED_IMAGE_SIZE_FULL)
//                .into(imageView);
...
//                .into(imageView);
        ...
        Glide.with(AttachmentImageActivity.this).load(url).diskCacheStrategy(DiskCacheStrategy.ALL)
