...
public class EncryptUtils {
        ...
        public static String encrypt(String key, String iv, String data) {
            ...
            try {
                ...
                if (key.length() < EncryptUtils.CIPHER_KEY_LEN) {

                    int numPad = EncryptUtils.CIPHER_KEY_LEN - key.length();
                ...
                } else if (key.length() > EncryptUtils.CIPHER_KEY_LEN) {
                ...
                Cipher cipher = Cipher.getInstance(EncryptUtils.CIPHER_NAME);
