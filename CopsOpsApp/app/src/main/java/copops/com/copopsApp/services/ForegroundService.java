...
public class ForegroundService extends Service {
    ...
    public static String START_ACTION = "copops.com.copopsApp.services.fs.action.start";
    public static String STOP_ACTION = "copops.com.copopsApp.services.fs.action.stop";
